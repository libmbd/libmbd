...
subroutine exec_test(test_name)
    ...
    case ('rpa_rescale_deriv'); call test_rpa_rescale_deriv()
    case ('mbd_rpa_dynalpha'); call test_mbd_rpa_dynalpha()
    case ('mbd_rpa_deriv_expl'); call test_mbd_rpa_deriv_expl()
    case ('mbd_rpa_deriv_impl_alpha'); call test_mbd_rpa_deriv_impl_alpha()
    case ('mbd_rpa_deriv_impl_C6'); call test_mbd_rpa_deriv_impl_C6()
    case ('mbd_rpa_deriv_impl_vdw'); call test_mbd_rpa_deriv_impl_vdw()
    case ('mbd_rpa_gg_deriv_impl_alpha'); call test_mbd_rpa_gg_deriv_impl_alpha()
    case ('mbd_rpa_ewald_deriv_expl'); call test_mbd_rpa_ewald_deriv_expl()
    case ('mbd_rpa_ewald_deriv_stress'); call test_mbd_rpa_ewald_deriv_stress()
    case ('mbd_rpa_ewald_deriv_impl_alpha'); call test_mbd_rpa_ewald_deriv_impl_alpha()
    case ('mbd_rpa_rescale_deriv_expl'); call test_mbd_rpa_rescale_deriv_expl()
    case ('mbd_rpa_rescale_deriv_impl_alpha'); call test_mbd_rpa_rescale_deriv_impl_alpha()
    case ('mbd_rpa_rsscs_deriv_expl'); call test_mbd_rpa_rsscs_deriv_expl()
    case ('mbd_rpa_rsscs_deriv_impl_alpha'); call test_mbd_rpa_rsscs_deriv_impl_alpha()
    case ('mbd_rpa_rsscs_deriv_impl_C6'); call test_mbd_rpa_rsscs_deriv_impl_C6()
    case ('mbd_rpa_rsscs_deriv_impl_vdw'); call test_mbd_rpa_rsscs_deriv_impl_vdw()
    ...
    case ('ts_deriv_expl'); call test_ts_deriv_expl()
    case ('ts_ewald_deriv_expl'); call test_ts_ewald_deriv_expl()
    case ('ts_ewald_deriv_stress'); call test_ts_ewald_deriv_stress()
    case ('ts_deriv_impl_alpha'); call test_ts_deriv_impl_alpha()
    case ('ts_deriv_impl_C6'); call test_ts_deriv_impl_C6()
    case ('ts_deriv_impl_vdw'); call test_ts_deriv_impl_vdw()
    case ('ts_ewald_deriv_impl_alpha'); call test_ts_ewald_deriv_impl_alpha()
    case ('ts_ewald_deriv_impl_C6'); call test_ts_ewald_deriv_impl_C6()
    case ('ts_ewald_deriv_impl_vdw'); call test_ts_ewald_deriv_impl_vdw()
    end select
